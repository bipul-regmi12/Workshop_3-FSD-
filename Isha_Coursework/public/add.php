...
<div class="page-header">
    <div class="page-title">
        <h1>Report Item</h1>
        <p style="color: var(--text-gray);">Submit a new lost or found item.</p>
    </div>
    ...
    <div class="card-body">
        ...
        <?php if($success): ?>
            <div class="alert" style="color: #6ee7b7; background: rgba(16, 185, 129, 0.1); padding: 1rem; border-radius: 8px; margin-bottom: 1rem; border: 1px solid rgba(16, 185, 129, 0.2);">
                <i class="fa-regular fa-circle-check"></i> <?php echo h($success); ?> <a href="index.php" style="color: inherit; text-decoration: underline;">View All Items</a>
            </div>
        <?php endif; ?>
